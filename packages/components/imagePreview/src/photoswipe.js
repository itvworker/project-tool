export default function(template, UiClass, items, options) {
     ...
     *
     */
    this.images = JSON.parse(JSON.stringify(items))
	...
	*/
    ...
    var _isOpen,
        ...
        _applyBgOpacity = function(opacity) {
            ...
            self.scrollWrap.style.opacity = opacity * _options.bgOpacity
        },
        ...
        _onFirstMouseMove = function() {
            ...
            if (_mouseMoveTimeout) {
                ...
                framework.addClass(template, 'preview--has_mouse')
        ...
        _setupTransforms = function() {
            ...
            _transformKey = 'left'
            framework.addClass(template, 'preview--ie')
    ...
    var publicMethods = {
        ...
        init: function() {
            ...
            self.bg = framework.getChildByClass(template, 'preview__bg')
            ...
            self.scrollWrap = framework.getChildByClass(template, 'preview__scroll-wrap')
            self.container = framework.getChildByClass(self.scrollWrap, 'preview__container')
            ...
            var rootClasses = 'preview--open '
            if (_options.mainClass) {
                rootClasses += _options.mainClass + ' '
            }
            if (_options.showHideOpacity) {
                rootClasses += 'preview--animate_opacity '
            }
            rootClasses += _likelyTouchDevice ? 'preview--touch' : 'preview--notouch'
            rootClasses += _features.animationName ? ' preview--css_animation' : ''
            rootClasses += _features.svg ? ' preview--svg' : ''
            ...
            framework.addClass(template, 'preview--visible')
        },
        ...
        destroy: function(isRemove) {
            ...
            _initalClassName = _initalClassName.split(' ')[0]
            if (!isRemove) {
                ...
                template.setAttribute('aria-hidden', 'true')
                template.className = _initalClassName + ' itv-able'
            }
        ...
        updateCurrZoomItem: function(emulateSetContent) {
            ...
            if (_itemHolders[1].el.children.length) {
                ...
                if (framework.hasClass(zoomElement, 'preview__zoom-wrap')) {
	...
	*/
    ...
    var _gestureStartTime,
        ...
        _closestElement = function(el, fn) {
            ...
            if (
                ...
                el.getAttribute('class').indexOf('preview__scroll-wrap') > -1
            ) {
                return false
            }
        ...
        _onDragRelease = function(e) {
            ...
            if (_verticalDragInitiated) {
                ...
                if (opacityRatio < _options.verticalDragRange) {
                    ...
                    _animateProp('verticalDrag', 0, 1, 300, framework.easing.cubic.out, function(
                        now
                    ) {
                        _panOffset.y =
                            (self.currItem.initialPosition.y - initalPanY) * now + initalPanY
        ...
        _showOrHide = function(item, img, out, completeFn) {
            ...
            var onComplete = function() {
                ...
                if (!out) {
                    ...
                    framework.addClass(template, 'preview--animated-in')
                    _shout('initialZoom' + (out ? 'OutEnd' : 'InEnd'))
                } else {
                    self.template.removeAttribute('style')
                    self.bg.removeAttribute('style')
                    self.scrollWrap.removeAttribute('style')
                }
            ...
            var startAnimation = function() {
                ...
                if (out && !closeWithRaf) {
                    framework.removeClass(template, 'preview--animated-in')
                }
                ...
                if (fadeEverything) {
                    if (out) {
                        framework[(closeWithRaf ? 'remove' : 'add') + 'Class'](
                            template,
                            'preview--animate_opacity'
                        )
                    } else {
                        setTimeout(function() {
                            framework.addClass(template, 'preview--animate_opacity')
                        }, 30)
                    }
                }
    ...
    var _items,
        ...
        _controllerDefaultOptions = {
            index: 0,
            errorMsg:
                '<div class="preview__error-msg"><a href="%url%" target="_blank">The image</a> could not be loaded.</div>',
    ...
    var _getItemAt,
        ...
        _preloadImage = function(item) {
            item.loading = true
            item.loaded = false
            var img = (item.img = framework.createEl('preview__img', 'img'))
            var onComplete = function() {
                item.loading = false
                item.loaded = true
    ...
    _registerModule('Controller', {
        publicMethods: {
            ...
            setContent: function(holder, index) {
                ...
                var baseDiv = (item.container = framework.createEl('preview__zoom-wrap'))
                ...
                if (item.src && !item.loadError && !item.loaded) {
                    ...
                    if (framework.features.transform) {
                        var placeholderClassName = 'preview__img preview__img--placeholder'
                        placeholderClassName += item.msrc ? '' : ' preview__img--placeholder--blank'
                    ...
                    img = framework.createEl('preview__img', 'img')
                    img.style.opacity = 1
                    img.src = item.src
            ...
            onTapRelease: function(e, releasePoint) {
                ...
                if (!_moved && !_isMultitouch && !_numAnimations) {
                    ...
                    if (
                        ...
                        framework.hasClass(e.target, 'preview__single-tap')
                    ) {
    ...
    _registerModule('DesktopZoom', {
        publicMethods: {
            ...
            setupDesktopZoom: function(onInit) {
                ...
                var hasDraggingClass,
                    updateZoomable = function() {
                        if (self.mouseZoomedIn) {
                            framework.removeClass(template, 'preview--zoomed-in')
                            self.mouseZoomedIn = false
                        }
                        if (_currZoomLevel < 1) {
                            framework.addClass(template, 'preview--zoom-allowed')
                        } else {
                            framework.removeClass(template, 'preview--zoom-allowed')
                        }
                        removeDraggingClass()
                    },
                    removeDraggingClass = function() {
                        if (hasDraggingClass) {
                            framework.removeClass(template, 'preview--dragging')
                ...
                _listen('pointerDown', function() {
                    if (self.mouseZoomedIn) {
                        ...
                        framework.addClass(template, 'preview--dragging')
                    }
                })
            ...
            toggleDesktopZoom: function(centerPoint) {
                ...
                framework[(!zoomOut ? 'add' : 'remove') + 'Class'](template, 'preview--zoomed-in')
            },
        },
    })
