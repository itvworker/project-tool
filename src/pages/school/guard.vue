<template lang="html">
    <el-container>
        <el-header class="list-header" style="height:100px">
            <el-row class="list-page-path">
                <el-breadcrumb separator-class="el-icon-arrow-right">
                    ...
                    <el-breadcrumb-item>门卫管理</el-breadcrumb-item>
                </el-breadcrumb>
            </el-row>
            <el-row :gutter="10">
                <el-col :xs="18" :sm="16" :md="18" :lg="18" :xl="20">
                    ...
                    <el-input type="text" style="width: 200px" placeholder="门卫名称" v-model="key" size="small"/>
                    <el-button type="primary" size="small" icon="el-icon-search">搜索</el-button>
                    <el-button size="small" icon="el-icon-refresh-left">重置</el-button>
                </el-col>
                <el-col :xs="6" :sm="8" :md="6" :lg="6" :xl="4" class="left-group">
                    <el-button class="btn btn-upload" size="small" @click="showStatus.dialog=true">导入门卫</el-button>
                    <el-button class="btn" size="small" @click="openAddBox">新增门卫</el-button>
                </el-col>
            </el-row>
        </el-header>
        ...
        <!--       导入   -->
        <el-dialog title="导入门卫" :visible.sync="showStatus.dialog" width="600px" :close-on-click-modal="false">
            <el-row>
        ...
        <el-dialog :title="form.id?'编辑门':'添加门卫'" :modal="false" :visible.sync="showStatus.edit" width="400px" :close-on-click-modal="false">
            <el-form :model="form" :rules="rules" ref="school" label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item label="所属学校" prop="school_id">
                 ...
                 <el-form-item label="门卫姓名" prop="guard_name">
                    <el-input v-model="form.latlng"></el-input>
                </el-form-item>
                <el-form-item label="门卫电话" prop="guard_tel">
                    <el-input v-model="form.latlng"></el-input>
                </el-form-item>
        ...
        methods: {
            getList() {
                try {
                    ...
                    let res = await this.$model.school.listGuard({
